                                       ...
                                       <?php if ($product->status == 0): ?>
                                           <div class="price-container">
                                               ...
                                               <span id="ProductPrice" class="h2 ProductPrice" itemprop="price"
                                                     content="5000000"><?php if($product->sale==0):?>
...
<!--                                                       góp</a>-->
                                               <?php endif; ?>
                                           <?php else: ?>
                                               <a href="/lien-he.html" class="btn-style-add btn btn-warning addtocart-modal">Liên hệ</a>
                                           <?php endif; ?>
                                       </div>
                        ...
                        <div class="col-lg-3 col-md-12 col-xs-12">
                            <div class="grid__item large--one-quarter" style="width: 100%!important;">
                                ...
                                <div class="collection-sidebar-block">
                                    ...
                                    <ul class="no-bullets cmu_tags">
                                        <?php if(!is_null($product->tags) && !empty($product->tags)): ?>
                                            <li class="filter--active">
                                                <?php foreach (explode(',',$product->tags) as $value):?>
                                ...
                                <div class="collection-sidebar-block">
                                    <div class="col-title">
                                        <h2 class="h3">Thương hiệu</h2>
                                    </div>
                                    <ul class="no-bullets brands">
                                        <li>
                                            <a class="brands" ><?= $product->brand->name?></a>
                                        </li>
                                    </ul>
                                </div>
                                ...
                                <div class="collection-sidebar-block">
                                    ...
                                    <div class="panel">
                                        <ul class="no-bullets">
                                            <?php $sanPhamNoiBat = \common\models\Product::find()->where(['active'=>1,'hot'=>1])->limit(5)->orderBy('id desc')->all();?>
                                                        ...
                                                        <div class="seenPro-info">
                                                            ...
                                                            <p class="seenPro-price">
                                                                ...
                                                                <span class="current-price">
                                                                    <?php if($sanPhamHot->sale>0):?>
                                                                    <?=$sanPhamHot->getSale()?>
                                                                        ₫<?php else:?>Giá: <span class="label label-danger" style="padding: 5px"><a href="/lien-he.html">Liên hệ</a></span><?php endif;?></span>
                                                                <?php if($sanPhamHot->sale<$sanPhamHot->retail && $sanPhamHot->sale>0):?>
