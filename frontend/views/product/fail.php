    ...
    <div class="container">
        <div class="row  wrap_cart">
            <div class="col-md-12 ">
                ...
                <div class="display-table-cell">
                    <h1><i class="fa fa-warning text-danger"></i> Đặt hàng không thành công</h1>
                    <p class="font-15"><span>Chào mừng các bạn đến với <strong><?=(isset($_SERVER['HTTPS']) ? "https" : "http") . "://$_SERVER[HTTP_HOST]"?></strong></p>
                </div>
                <div class="alert alert-danger padding15 margin-top-bot-10">
                    <div class="">
                        <p>Xin lỗi.</p>
                        <p>Đơn hàng của bạn xảy ra lỗi, vui lòng liên hệ với hỗ trợ của chúng tôi.</p>
