...
<div class="news-container brandcon">
    <div class="content-product">
        ...
        <div class="container">
            ...
            <div class="col-lg-collection-left hidden-md hidden-sm hidden-xs clearfix">
                ...
                <?php echo \yii\helpers\Html::textInput('catid', $brand->id, ['class' => 'hidden']) ?>
                <div class="filter-destop">
                    <h3>
                        Filter brand "<?= $brand->name?>"
                    </h3>
                    <div class="filter-box">
                        <p aria-expanded="false">Category<i class="fa fa-angle-down hidden-lg"></i></p>
                            ...
                            <?php foreach ($category as $value): ?>
                                <li>
                                    <label data-filter="<?= func::taoduongdan($value->name) ?>"
                                        ...
                                        <input name="category[]" type="checkbox" value="<?= $value->id ?>">
