...
<main class="main-content" role="main">
    ...
    <section id="home-services">
        <div class="wrapper">
            <div class="inner">
                <?php $services = \common\models\Partner::find()->where('position=4 and active=1')->all(); ?>
                ...
                <div class="grid">
                    ...
                    <div class="grid__item large--four-twelfths medium--six-twelfths small--one-whole col-md-4 col-xs-12">
        ...
        <div class="wrapper">
            <div class="inner">
                ...
                <div class="grid list-products">
                    ...
                    <div class="owl-carousel owl-enable suplo-owl owl-theme">
                        <?php
                                ...
                                <div class="inner">
                                    ...
                                    <div class="product--loop__info">
                                        ...
                                        <div class="product--loop__price">
                                            <span class="current-price"><?=$sanpham->getSale()." ".$config['money_suffix']?></span>

                                            <?php if($sanpham->sale<$sanpham->retail):?>
                                    ...
                                    <div class="product--loop__actions medium-down--hide">
                                        <a href="<?=$sanpham->getLink()?>" class="btn">Chi
                                            tiết</a>
                                        <a href="<?=$sanpham->getLink()?>" style="background-color: #576398;color: white" class="btn">Mua Ngay</a>
                                    </div>

                                    <?php if($sanpham->sale<$sanpham->retail):?>
                                    <span class="product--loop__status">-<?=round(($sanpham->retail-$sanpham->sale)/$sanpham->retail,0)?>%</span>
                                    <?php endif;?>
            ...
            <div class="inner">
                ...
                <div class="home-articles-wrapper grid">
                    <div id="owl-home-articles-slider" class="owl-carousel owl-enable owl-theme">
                        <?php $news = \common\models\News::find()->where('active = 1 and home = 1')->all();
                ...
                <div class="home-clients-wrapper">
                    <div id="owl-home-partners" class="owl-carousel owl-enable owl-theme">
                        ...
                        <div class="item wow fadeInDown">
                            ...
                            <a href="<?=$pn->url?>" target="<?=$pn->url?>"><img
        ...
        <div class="wrapper">
            <div class="inner">
                <h2 class="testi-title">
                    <span>NHẬN XÉT</span> CỦA KHÁCH HÀNG
                </h2>
                <div class="home-testimonials-wrapper grid">
                    <div id="owl-home-testimonials" class="owl-carousel owl-enable owl-theme">

                        <?php $khachhangcomment = \common\models\Comment::find()->where(['active'=>1])->orderBy("id desc")->all();
                            ...
                            <div class="testi-wrapper wow fadeInDown">
                                <div class="testimonial-img">
                                    <img src="<?=$comment->image?>"
                                         alt="Nhận xét của <?=$comment->name?>">
                                </div>
                                <p class="testi-author">
                                    Nhận xét của <?=$comment->name?>
                                </p>
                                ...
                                <div class="rte">
                                    <p class="testi-desc">“<?=$comment->content?>”</p>
                                </div>
                            </div>
                        </div>
                        <?php endforeach;?>
