...
<!--            --><?//= Html::submitButton('Gửi <i class="m-icon-swapright m-icon-white"></i>', ['class' => 'btn blue pull-right', 'name' => 'login-button']) ?>
...
<!-- BEGIN COPYRIGHT -->
<div class="copyright">
    Develope by <a href="http://AnPham" rel="nofollow" title="AnPham">AnPham</a>
</div>
<!-- END COPYRIGHT -->
