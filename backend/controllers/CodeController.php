...
use common\models\search\Code as CodeSearch;
...
class CodeController extends Controller
{
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Tạo mới Code",
                    'content'=>'<span class="text-success">Create Code success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Code model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
    ...
    {
        $catproduct = Code::find()->where(['id'=>$_POST['id']])->one();
        Code::updateAll(['active'=>(1-$catproduct->active)],['id'=>$catproduct->id]);
    }
}
