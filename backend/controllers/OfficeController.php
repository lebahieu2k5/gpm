...
class OfficeController extends Controller
{
    ...
    {
        $model = Office::find()->where(['id'=>$_POST['id']])->one();
        Office::updateAll(['active'=>(1-$model->active)],['id'=>$model->id]);
    }

    public function actionUpdateord()
    {
        $model = Office::find()->where(['id'=>$_POST['id']])->one();
        Office::updateAll(['ord'=>$_POST['value']],['id'=>$model->id]);
    }
}
