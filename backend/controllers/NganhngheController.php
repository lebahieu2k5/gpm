...
use Yii;
use common\models\Nganhnghe;
use common\models\search\NganhngheSearch;
...
class NganhngheController extends Controller
{
    ...
    {    
        $searchModel = new NganhngheSearch();
            ...
            */
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'title'=> "Tạo mới Ngành Nghề",
                    'content'=>'<span class="text-success">Create Nganhnghe success</span>',
                    'footer'=> Html::button('Close',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Nganhnghe model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Nganhnghe model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
